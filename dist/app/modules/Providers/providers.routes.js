...
router.get("/my-profile", (0, auth_1.default)(client_1.UserRole.PROVIDER), providers_controller_1.ProviderController.getMyProfile);
router.patch("/my-profile", (0, auth_1.default)(client_1.UserRole.PROVIDER), providers_controller_1.ProviderController.updateMyProfile);
router.get("/dashboard-stats", (0, auth_1.default)(client_1.UserRole.PROVIDER), providers_controller_1.ProviderController.getDashboardStats);
