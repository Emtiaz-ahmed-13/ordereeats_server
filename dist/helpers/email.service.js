...
exports.emailService = {
    ...
    sendVerificationEmail: (email, name, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    sendPasswordResetEmail: (email, name, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    sendOrderConfirmationEmail: (email, name, orderDetails) => __awaiter(void 0, void 0, void 0, function* () {
        const mailOptions = {
            from: process.env.EMAIL_FROM || 'OrderEats <noreply@ordereats.com>',
            to: email,
